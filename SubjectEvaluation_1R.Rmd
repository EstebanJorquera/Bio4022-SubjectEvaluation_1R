...
>>>>>>> a74d3658fe516925f2c9a91a20fd379aafd5918f
  ) %>% 
  rename(
    Genus = genus
  )
...
<<<<<<< HEAD
Human wildlife observations registered `r ifelse(year_to != year_from,{paste ("from",as.numeric(year_from),"to",as.numeric(year_to))},{paste("since",as.numeric(year_to))})` have produced `r dplyr::count(Delphinidae_Data)` observations of members of the *Delphinidae* family, registering locational ocurrence data for `r dplyr::count(summarise(group_by(Delphinidae_Data,speciesKey)))` species, between `r dplyr::count(Delphinidae_Species)` genera.
...
```{r Data tables, fig.align="center", fig.width=6, fig.height=6, fig.cap="Table 1. Observation data of members of the Delphinidae family obtained from the Global Biodiversity Information Facility, corresponding to the analysed period, depicting the number of occurrences per species."}
...
```{r Data plots, fig.align="center", fig.width=6, fig.height=6, fig.cap="Figure 1. Observation data of members of the Delphinidae family grouped by genera, obtained from the Global Biodiversity Information Facility, corresponding to each year of the analysed period."}
...
```{r Data mapping, fig.align="center", fig.width=6, fig.height=6, fig.cap="Figure 2. Location data of members of the Delphinidae family grouped by genera, obtained from the Global Biodiversity Information Facility,corresponding to the analysed period."}
